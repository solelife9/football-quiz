...
import { TOP10, COMBO10, LINEUPS, CAREERS, OXQUIZ } from './data'
...
const GAMES: GameCard[] = [
  ...
  { route: 'combo10', name: '조건 겹치기 TOP 10', desc: '조건을 겹친 주제의 TOP 10', count: COMBO10.length },
...
export default function App() {
  ...
  switch (route) {
    ...
    case 'combo10':
      return (
        <Top10Game gameKey="combo10" title="조건 겹치기 TOP 10" questions={COMBO10} rules={GAME_RULES.combo10} onBack={back} />
      )
    case 'lineup':
